...
# RISC-V patches
Patch701: riscv-chromium-variations-133.patch
Patch702: swiftshader-use-llvm16.patch
Patch703: Debian-fix-rust-linking.patch
Patch704: highway-disable-rvv.patch
Patch705: riscv-dav1d.patch
Patch706: riscv-sandbox-137.patch
Patch707: riscv-cpuinfo-137.patch
Patch708: riscv-xnnpack-137.patch
Patch709: compiler-rt-riscv.patch
Patch710: 0001-chrome-runtime_api_delegate-add-riscv64-define.patch
Patch711: 0001-extensions-common-api-runtime.json-riscv64-support.patch
Patch712: riscv-ffmpeg-137-filtered.patch
...
# node tools for riscv64
# Source14 generated by command:
...
#  tar --zstd -cpf chromium-node-modules-riscv64-4.21.0.tar.zst -C third_party node
Source14: chromium-node-modules-riscv64-4.21.0.tar.zst
# Source15 generated by command:
...
#  tar --zstd -cpf chromium-devtools-frontend-4.24.3-riscv64.tar.zst -C third_party/devtools-frontend src
Source15: chromium-devtools-frontend-4.24.3-riscv64.tar.zst
...
%ifarch  riscv64
#patch -P700 -p1 -b .riscv-build

%patch -P701 -p1 -b .riscv-chromium-variations-133
%patch -P702 -p0 -b .swiftshader-use-llvm16
%patch -P703 -p0 -b .Debian-fix-rust-linking
%patch -P704 -p1 -b .highway-disable-rvv
%patch -P705 -p1 -b .riscv-dav1d
%patch -P706 -p1 -b .riscv-sandbox-137
%patch -P707 -p1 -b .riscv-cpuinfo-137
%patch -P708 -p1 -b .riscv-xnnpack-137
%patch -P709 -p1 -b .compiler-rt-riscv
%patch -P710 -p1 -b .0001-chrome-runtime_api_delegate-add-riscv64-define
%patch -P711 -p1 -b .0001-extensions-common-api-runtime.json-riscv64-support
%patch -P712 -p1 -d third_party/ffmpeg -b .riscv-ffmpeg-137

rm -rf third_party/node
tar xpf %{SOURCE14} -C third_party
rm -rf third_party/devtools-frontend/src
tar xpf %{SOURCE15} -C third_party/devtools-frontend
...
%changelog
* Mon Jul 7 2025 Liu Yang <yanliu@redhat.com> - 137.0.7151.119-1.rv64
- Add RISC-V support
- Refer to the link from Arch Linux
  https://github.com/felixonmars/archriscv-packages/commit/bd23414bdc15dfe33d76a472965cb8930dcd48c4
